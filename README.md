...
![Version: 1.7.2](https://img.shields.io/badge/Version-1.7.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2026.1.17](https://img.shields.io/badge/AppVersion-2026.1.17-informational?style=flat-square)
...
| images | object | `{"dflconnector":{"pullPolicy":"IfNotPresent","repository":"moovit/de.moovit.vulcano-dfl-connector","tag":"0.2.20"},"filetransfer":{"pullPolicy":"IfNotPresent","repository":"moovit/vulcano-filetransfer","tag":"0.0.10"},"vulcano":{"pullPolicy":"IfNotPresent","repository":"moovit/vulcano","tag":"2026.1.17"}}` | Docker Image Configuration |
...
| images.vulcano.tag | string | `"2026.1.17"` | Docker image tag |
...
| mongoBackup.mongo | object | `{"host":"","port":"","username":""}` | MongoDB connection overrides. Blank values derive from the mongodb.* config. |
| mongoBackup.mongo.host | string | `""` | Override MongoDB host (default: derived from mongodb config) |
| mongoBackup.mongo.port | string | `""` | Override MongoDB port (default: derived from mongodb.port) |
